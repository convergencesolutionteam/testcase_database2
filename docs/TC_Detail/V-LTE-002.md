...
|---|---|---|---|
| V-LTE-002 | Upgrade VoLTE Call to ViLTE | 4G | ViLTE |
...
2. With in Setup Time attempt make a Video Call  
3. Once connected, continue Video call session for the Traffic Duration.
