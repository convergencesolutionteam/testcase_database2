...
|---|---|---|---|
| FNC-NSA-007 | MO & MT- RTT-Message - LTE, NSA | 5G-NSA,4G | Message Service |
...
2. With in Setup Time attempt make a RTT Call  
3. Once connected, Send Message to each other and continue calls for the Traffic Duration Time.
