...
|---|---|---|---|
| ACC-NSA-004 | Roaming Registration Success Rate during airplane mode On/Off | 5G-NSA | Access |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify Roaming Registration Success Rate (4G LTE/5G-NSA) during Airplane mode toggle, and compare results between DUT and Reference device.
...
Roaming Registration Success Rate [%]
