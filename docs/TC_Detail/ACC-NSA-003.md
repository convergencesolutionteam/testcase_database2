...
|---|---|---|---|
| ACC-NSA-003 | RACH success rate for Near/Mid/Far cell (with Airplane mode On/Off) | 5G-NSA | Access |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify RACH success rate with Airplane mode toggle at Cell Near and compare results between DUT and Reference device
