...
|---|---|---|---|
| LTE-MCX-07 | RTP Stream Stability | 4G | MCX |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify RTP packet delivery stability by analyzing jitter, packet loss, and packet order during a voice call.

<br>

### Test Procedure {: .tc-shaded-header }

Analyzes the occurrence of jitter, packet loss, and out-of-order delivery of RTP packets received while a voice call is maintained.
