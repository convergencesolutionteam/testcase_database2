...
|---|---|---|---|
| DSDS-ALL-004 | DSDS Uplink Throughput Test | 5G-SA,5G-NSA,4G | DSDS |
...
UL Physical Layer Throughput [Mbps]  
UL MAC Layer Throughput [Mbps]  
UL Application Layer Throughput [Mbps]
