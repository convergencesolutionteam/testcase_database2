...
|---|---|---|---|
| FNC-NSA-001 | CA Cell Addition Success Rate in Near/Mid/Far Cell | 5G-NSA | Feature test |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify CA cell addition success rate at Cell Near and compare results between DUT and Reference device
