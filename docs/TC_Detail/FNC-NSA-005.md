...
|---|---|---|---|
| FNC-NSA-005 | Ping Latency and Packet Loss in Near/Mid/Far Cell | 5G-NSA | Ping |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify Ping latency and packet loss at Cell Near and compare results between DUT and Reference device
