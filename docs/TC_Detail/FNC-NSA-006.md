...
|---|---|---|---|
| FNC-NSA-006 | MO & MT- MMS-Message - LTE, NSA | 5G-NSA,4G | Message Service |
...
2. With in Setup Time attempt compose and send Picture.  
3. Within Traffic time wait for the Picture to receive on MT.
