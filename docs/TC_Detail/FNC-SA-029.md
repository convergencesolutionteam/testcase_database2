...
|---|---|---|---|
| FNC-SA-029 | User Plane Latency - n byte ping - SA,NSA,LTE | 5G-SA,5G-NSA,4G | Ping |
...
1. Ping request set to 32 bytes  
2. Ping request and response as many as set Count.  
3. RTT Avg. should be measured within 80ms.
