...
|---|---|---|---|
| DSDS-ALL-002 | DSDS Downlink Throughput Test | 5G-SA,5G-NSA,4G | DSDS |
...
DL Physical Layer Throughput [Mbps]  
DL MAC Layer Throughput [Mbps]  
DL Application Layer Throughput [Mbps]
