...
|---|---|---|---|
| TIFG-E2E-7.1.2A | File upload/download(Poor/Good/Fair/Excellent position) - SA,NSA | 5G-SA,5G-NSA | Throughput |
...
Pass NR Download Throughput  
Pass NR Upload Throughput  
RSRP(Max)  
RSRP(Min)  
SINR(Max)  
SINR(Min)
