...
|---|---|---|---|
| WiFi-WiFi7-06 | Regression Test | Wi-Fi | Wi-Fi |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify system stability and functional consistency across AP firmware updates through repeated execution.

<br>

### Test Procedure {: .tc-shaded-header }

Repeated execution of the same scenario before and after AP firmware updates
