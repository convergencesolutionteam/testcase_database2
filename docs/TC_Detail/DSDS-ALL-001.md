...
|---|---|---|---|
| DSDS-ALL-001 | DSDS Downlink Data Volume Test | 5G-SA,5G-NSA,4G | DSDS |
...
DL Physical Layer Data Volume [%]  
DL Physical Layer Data Volume [MB]  
DL MAC Layer Data Volume [%]  
DL MAC Layer Data Volume [MB]  
DL Application Layer Data Volume [%]  
DL Application Layer Data Volume [MB]
