...
|---|---|---|---|
| HO-LTE-003 | LTE Inter-frequency Handover (with VoLTE) | 4G | Handover_4G |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify successful S1-based inter-frequency handover during an active VoLTE call in LTE.
