...
|---|---|---|---|
| ACC-NSA-005 | RRC Reconfiguration complete success rate during mobility | 5G-NSA | Access |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify RRC Reconfiguration complete success rate during mobility and compare results between DUT and Reference device
