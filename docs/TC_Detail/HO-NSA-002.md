...
|---|---|---|---|
| HO-NSA-002 | NSA Inter-frequency Handover (Max UEs) | 5G-NSA | Handover_5G-NSA |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify S1-based inter-frequency handover performance and success rate for the maximum number of UEs in LTE+NR.
