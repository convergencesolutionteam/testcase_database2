...
|---|---|---|---|
| APP-SA-004 | Youtube HD Streaming Quality during Handover | 5G-SA | Application Stationary Test |
...
NR PDSCH Throughput  
Verfity Video Quality[%]  
Youtube HD Streaming Quality  
Intra-NR HO Success Rate[%]  
Intra-NR HO Latency(RCR to RCR Complete)[ms]
