...
|---|---|---|---|
| LTE-MCX-04 | Late Call Entry Time (KPI4) | 4G | MCX |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify the time required for a user to successfully join and output audio from an ongoing group call.

<br>

### Test Procedure {: .tc-shaded-header }

Measures the time from the moment the decision is made to join a group call where voice is already being transmitted until the audio of the call starts being output through the terminal's speaker.
