...
|---|---|---|---|
| V-NSA-001 | MO-MT Voice Call Success Rate during Mobility | 5G-NSA | VoLTE |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify MO/MT Voice call success rate during mobility and compare results between DUT and Reference device
