...
|---|---|---|---|
| V-NSA-005 | VoLTE Call Establishment and Voice Quality Performance | 5G-NSA,4G | VoLTE |
...
2. With in Setup Time attempt make a Voice Call  
3. Once connected, continue Voice call session for the Traffic Duration.
