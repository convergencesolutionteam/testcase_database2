...
|---|---|---|---|
| ACC-NSA-006 | SIP registration success rate during airplane mode ON/OFF | 5G-NSA | Access |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify SIP registration success rate during Airplane mode toggle and compare results between DUT and Reference device
