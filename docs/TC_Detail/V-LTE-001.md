...
|---|---|---|---|
| V-LTE-001 | CSFB Establishment and Latency Performance | 4G | CSFB |
...
MO Voice Call Success Rate  
MT Voice Call Success Rate  
MO CDMA CSFB latency[ms]  
MT CDMA CSFB latency[ms]
