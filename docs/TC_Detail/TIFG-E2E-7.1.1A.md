...
|---|---|---|---|
| TIFG-E2E-7.1.1A | Web Browsing(Poor/Good/Fair/Excellent position) | 5G-NSA | Application Stationary Test |
...
Pass DNS Resolution Time (ms)  
Pass Time To First Byte (ms)  
Pass Page Load Time (ms)  
RSRP(Max)  
RSRP(Min)  
SINR(Max)  
SINR(Min)
