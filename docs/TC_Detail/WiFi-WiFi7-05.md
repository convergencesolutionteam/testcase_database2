...
|---|---|---|---|
| WiFi-WiFi7-05 | MLO Link Reliability | Wi-Fi | Wi-Fi |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify the connection reliability advantage of multi-link operations over a single link under extreme fading.

<br>

### Test Procedure {: .tc-shaded-header }

Compare connection retention of single link vs. multi-link under extreme signal attenuation conditions
...
WiFi DL Throughput Resilience Rate [%]
