...
|---|---|---|---|
| HO-LTE-004 | LTE Intra-frequency Handover (with Data) | 4G | Handover_4G |

<div class="tc-content-border-box" markdown="1">

### Purpose {: .tc-shaded-header }

Verify successful S1-based intra-frequency handover during active DL TCP data transfer in LTE.
